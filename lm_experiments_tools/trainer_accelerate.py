                ...
                with grad_sync_context(self.model):
                    ...
                    if not is_train_mode and self.args.use_generate_on_valid:
                        ...
                        if 'attention_mask_generate' in subbatch:
                            generate_kwargs['attention_mask'] = subbatch['attention_mask_generate']
                        ...
                        if 'input_ids_generate' in subbatch:
                            generation_outputs = self.accelerator.unwrap_model(self.model).generate(subbatch['input_ids_generate'], **generate_kwargs)
                        else:
