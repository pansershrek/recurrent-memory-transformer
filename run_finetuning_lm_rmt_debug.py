...
parser.add_argument('--base_model_forward_func', type=str, help='path to custom forward funсtion', default=None)
...
if __name__ == '__main__':
    ...
    if args.base_model_forward_func is not None:
        base_model_forward_func = get_cls_by_name(args.base_model_forward_func)
    else:
        base_model_forward_func = None
    ...
    if args.num_mem_tokens is not None:
        ...
        model = recurrent_wrapper_cls(cell, 
                                      ...
                                      k2=args.k2,
                                      base_model_forward_func=base_model_forward_func
        )
