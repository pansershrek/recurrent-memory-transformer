...
parser.add_argument("--prediction_frequency", type=int, default=2,
                    help="memup will use hidden state of rmt to make long term predictions every [prediction_frequency] recurrent steps")
...
if __name__ == '__main__':
    ...
    if args.vary_n_segments:  # choose sample sizes according to each number of segments up to args.max_n_segments
        train_sample_size = [int(args.segment_size * i) for i in range(1, args.max_n_segments + 1)]
    ...
    if args.num_mem_tokens is not None:
        ...
        model = recurrent_wrapper_cls(cell, 
                                      ...
                                      prediction_frequency=args.prediction_frequency,
                                      k2=args.k2,
