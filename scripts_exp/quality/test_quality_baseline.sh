...
for LR in 1e-04 3e-04 5e-04 5e-05
do
...
accelerate launch --config_file $ACCEL_CONFIG --main_process_port 29563 run_finetuning_scrolls_rmt_decoder.py \
        --task_name $TASK_NAME \
        --model_path ../runs/test/${TASK_NAME}/$MODEL_NAME/lr${LR}_${SCHEDULER}_adamw_wd1e-03_${INPUT_SEQ_LEN}-${MAX_N_SEGMENTS}x${INPUT_SIZE}_mem${MEMORY_SIZE}_bs${TBS}_iters${ITERS}_${SEGMENT_ORDERING}/run_$N \
