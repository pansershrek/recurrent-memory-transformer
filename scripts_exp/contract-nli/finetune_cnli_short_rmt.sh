...
MAX_N_SEGMENTSS=(1 2 1 2)
MEMORY_SIZES=(2 2 8 8)
BSS=(128 64 128 64)
...
accelerate launch --config_file $ACCEL_CONFIG --main_process_port 29578 run_finetuning_scrolls_rmt_decoder_v3.py \
        --task_name $TASK_NAME \
        --model_path ../runs/${TASK_NAME}/$MODEL_NAME/lr${LR}_${SCHEDULER}_adamw_wd1e-03_${INPUT_SEQ_LEN}-${TGT_LEN}-${MAX_N_SEGMENTS}x${INPUT_SIZE}_mem${MEMORY_SIZE}_bs${TBS}_iters${ITERS}_${SEGMENT_ORDERING}_bptt-${K2}_v3/run_$N \
