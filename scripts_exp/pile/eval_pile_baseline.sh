...
accelerate launch --config_file $ACCEL_CONFIG --main_process_port 29561 run_finetuning_pile_rmt.py \
        --task_name $TASK_NAME \
        ...
        --backbone_cpt ../runs/${TASK_NAME}/EleutherAI/pythia-70m-deduped/lr1e-05_linear_adamw_wd1e-03_0-2048-1x2048_mem0_bs256_regular_bptt-1/run_1 \
