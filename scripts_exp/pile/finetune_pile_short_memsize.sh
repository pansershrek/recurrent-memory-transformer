...
accelerate launch --config_file ./accel_configs/deepspeed_fp16_o2_np1.yaml --main_process_port 29521 run_finetuning_pile_rmt_deepspeed.py \
        --task_name $TASK_NAME \
