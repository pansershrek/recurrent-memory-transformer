...
accelerate launch --config_file $ACCEL_CONFIG --main_process_port 29567 run_finetuning_pile_rmt.py \
        --task_name $TASK_NAME \
        --model_path ../runs/${TASK_NAME}/$MODEL_NAME/lr${LR}_${SCHEDULER}_adamw_wd1e-03_${BLOCK_SIZE}-${EVAL_HISTORY_SIZE}-${EVAL_N_SEGMENTS}x${INPUT_SIZE}_mem${MEMORY_SIZE}_bs${TBS}_${SEGMENT_ORDERING}_bptt-${K2}_sp0.2_eval_32k+_20kdoc_2-${EVAL_N_SEGMENTS}/run_$N \
        --from_pretrained $MODEL_NAME \
        --backbone_cpt ../runs/${TASK_NAME}/EleutherAI/pythia-1b-deduped/lr1e-05_linear_adamw_wd1e-03_2044-2044-2x2048_mem2_bs256_regular_bptt-2_sp0.2/run_1/ \
