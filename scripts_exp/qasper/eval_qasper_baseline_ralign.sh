...
accelerate launch --config_file $ACCEL_CONFIG --main_process_port 29562 run_finetuning_scrolls_rmt_decoder_ralign.py \
        --task_name $TASK_NAME \
        --model_path ../runs/${TASK_NAME}/$MODEL_NAME/lr3e-04_linear_adamw_wd1e-03_1024-1x1024_mem0_bs4_iters1000000_regular_v2_eval_bs4_ralign/run_$N \
        --from_pretrained $MODEL_NAME \
        --model_type $MODEL_TYPE \
        --memory_cell_cls $MEMORY_CELL \
        --recurrent_wrapper_cls $RECURRENT_WRAPPER \
        --model_cls $BACKBONE_CLS \
        --model_cpt ../runs/${TASK_NAME}/$MODEL_NAME/lr3e-04_linear_adamw_wd1e-03_1024-1x1024_mem0_bs4_iters1000000_regular_v2/run_1 \
