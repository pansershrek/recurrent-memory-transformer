...
accelerate launch --config_file $ACCEL_CONFIG --main_process_port 29001 run_finetuning_babilong_rmt.py \
        ...
        --model_cpt /home/jovyan/rmt/runs/babilong/${TASK_DATASET}/$MODEL_NAME/lr${LR}_${SCHEDULER}_adamw_wd1e-03_${SRC_N_SEGMENTS}x${SEGMENT_SIZE}_mem${MEMORY_SIZE}_bs64_bptt-${K2}_from_cpt_4-32_vary/run_1/model_best/ \
