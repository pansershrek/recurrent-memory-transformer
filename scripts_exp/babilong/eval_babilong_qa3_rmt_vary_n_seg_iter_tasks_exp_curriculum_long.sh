...
accelerate launch --config_file $ACCEL_CONFIG --main_process_port 29064 run_finetuning_babilong_rmt_long.py \
        ...
        --model_path /home/jovyan/rmt/runs/babilong/${TASK_DATASET}/$MODEL_NAME/${SCHEDULER}_adamw_wd1e-03_${MAX_N_SEGMENTS}x${SEGMENT_SIZE}_mem${MEMORY_SIZE}_bs64_bptt-${K2}_eval_from_${SRC_N_SEGMENTS}x${SEGMENT_SIZE}_long/run_$N \
