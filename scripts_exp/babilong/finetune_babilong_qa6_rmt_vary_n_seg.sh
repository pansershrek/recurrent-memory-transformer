...
for TASK_DATASET in qa6_yes-no-questions
do
...
accelerate launch --config_file $ACCEL_CONFIG --main_process_port 29010 run_finetuning_babilong_rmt.py \
        ...
        --model_path /home/jovyan/rmt/runs/babilong/${TASK_DATASET}/$MODEL_NAME/${SCHEDULER}_adamw_wd1e-03_${MAX_N_SEGMENTS}x${SEGMENT_SIZE}_mem${MEMORY_SIZE}_bs${TBS}_bptt-${K2}_from_cpt_0-${MAX_N_SEGMENTS}/run_$N \
