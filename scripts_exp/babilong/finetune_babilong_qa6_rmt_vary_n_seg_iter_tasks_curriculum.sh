...
MAX_N_SEGMENTSS=(1 2 4 6 8 16 32 64)
BSS=( 32 16 16 8 8 4 2 1)
...
accelerate launch --config_file $ACCEL_CONFIG --main_process_port 29011 run_finetuning_babilong_rmt.py \
