...
for MAX_N_SEGMENTS in 2 4 8 16 32 64 128 256
do
...
#accelerate launch --config_file $ACCEL_CONFIG --main_process_port 29054 run_finetuning_babilong_rmt.py \
 python3 run_finetuning_babilong_rmt.py \
        ...
        --model_path /mnt/g.skiba/recurrent-memory-transformer/runs/babilong/${TASK_DATASET}/$MODEL_NAME/${SCHEDULER}_adamw_wd1e-03_${MAX_N_SEGMENTS}x${SEGMENT_SIZE}_mem${MEMORY_SIZE}_bs64_bptt-${K2}_eval_from_${SRC_N_SEGMENTS}x${SEGMENT_SIZE}_bs1/run_$N \
