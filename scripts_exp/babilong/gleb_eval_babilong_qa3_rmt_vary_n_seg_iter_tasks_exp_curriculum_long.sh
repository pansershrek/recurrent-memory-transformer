...
for MAX_N_SEGMENTS in 2048 19532 195313
do
...
accelerate launch --config_file $ACCEL_CONFIG --main_process_port 29064 run_finetuning_babilong_rmt_long.py \
        --task_dataset $TASK_DATASET \
        --noise_dataset $NOISE_DATASET \
        --babi_path /mnt/g.skiba/recurrent-memory-transformer/data/tasks_1-20_v1-2/en-10k \
        --model_path /mnt/g.skiba/recurrent-memory-transformer/runs/babilong/${TASK_DATASET}/$MODEL_NAME/${SCHEDULER}_adamw_wd1e-03_${MAX_N_SEGMENTS}x${SEGMENT_SIZE}_mem${MEMORY_SIZE}_bs64_bptt-${K2}_eval_from_${SRC_N_SEGMENTS}x${SEGMENT_SIZE}_long/run_$N \
