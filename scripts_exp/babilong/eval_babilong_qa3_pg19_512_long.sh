...
MAX_N_SEGMENTSS=(19532) #(1 2 4 8 16 32 64 128 250 1024 2048) #(19532) #(1024 2048 19532) #(1024 2048 19532 195313) #
...
EXP_PATH=${RUNS_PATH}/lr3e-05_linear_adamw_wd1e-03_seqlen16384_32x512_mem16_r32_w16_bs64__bptt--1_sp0.5_retr_attention_from_16x512/run_4
...
accelerate launch --num_processes $NP --main_process_port 29313 --config_file $ACCEL_CONFIG run_finetuning_babilong_rmt.py \
