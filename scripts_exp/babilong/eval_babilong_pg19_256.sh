...
SEGMENT_SIZE=256 # size of one segment in tokens
SAMPLE_SIZE=1024 # length of task sample in tokens
MAX_N_SEGMENTS=4

SAMPLE_SIZES=(128000) # (32768 65536 128000) #(256 512 1024 2048 4096 8192 16384 32768 65536) # (256 512 1024 2048 4096 8192 16384) #(32768 65536) #
MAX_N_SEGMENTSS=(500) # (128 256 500) #(1 2 4 8 16 32 64 128 256) # (1 2 4 8 16 32 64) # (128 256)
...
EXP_PATH=./runs/babilong/qa1_single-supporting-fact/pg19/gpt2/lr5e-05_linear_adamw_wd1e-03_seqlen8192_32x256_mem10_r20_w10_bs64__bptt--1_sp0.5_retr_attention_from_16x256/run_1
...
accelerate launch --num_processes $NP --main_process_port 29012 --config_file $ACCEL_CONFIG run_finetuning_babilong_rmt.py \
