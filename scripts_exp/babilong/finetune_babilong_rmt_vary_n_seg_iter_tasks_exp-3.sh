...
for TASK_DATASET in qa2_two-supporting-facts qa3_three-supporting-facts
do
...
accelerate launch --config_file $ACCEL_CONFIG --main_process_port 29006 run_finetuning_babilong_rmt.py \
