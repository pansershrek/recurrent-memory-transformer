...
for MAX_N_SEGMENTS in 1 2 4 8 16 32 64 128
do
...
accelerate launch --config_file $ACCEL_CONFIG --main_process_port 29021 run_finetuning_babilong_rmt.py \
        ...
        --model_cpt /home/jovyan/rmt/runs/babilong/${TASK_DATASET}/$MODEL_NAME/lr5e-05_linear_adamw_wd1e-03_8x512_mem16_bs64_bptt--1_vary/run_1/model_best/ \
