...
python3 run_finetuning_babilong_rmt.py \
        ...
        --model_path /mnt/g.skiba/recurrent-memory-transformer/runs/babilong/${TASK_DATASET}/$MODEL_NAME/${SCHEDULER}_adamw_wd1e-03_${MAX_N_SEGMENTS}x${SEGMENT_SIZE}_mem${MEMORY_SIZE}_bs${TBS}_bptt-${K2}_from_cpt_0-1/run_$N \
