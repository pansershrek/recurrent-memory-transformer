...
MAX_N_SEGMENTSS=(2 2 3 3)
MEMORY_SIZES=(2 5 2 5)
BSS=(32 32)
...
horovodrun --gloo -np $NP python run_finetuning_lm_lora_rmt.py \
        --task_name $TASK_NAME \
        --model_path ../runs/lm/${TASK_NAME}/$MODEL_NAME/lr${LR}_${SCHEDULER}_adamw_wd1e-03_${INPUT_SEQ_LEN}-${TGT_LEN}-${MAX_N_SEGMENTS}x${INPUT_SIZE}_mem${MEMORY_SIZE}_bs${TBS}_iters${ITERS}_${SEGMENT_ORDERING}_bptt-${K2}_lora_freeze/run_$N \
