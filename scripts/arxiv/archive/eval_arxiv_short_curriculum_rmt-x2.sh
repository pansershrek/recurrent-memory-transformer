...
MAX_N_SEGMENTSS=(2 3 4 5 6 7 8 9 10 16 32)
BSS=(32 32 16 16 16 16 16 8 8 8 8 4)

MAX_N_SEGMENTSS=(4 5 6 7 8 9 10 16 32)
BSS=(16 16 16 8 8 8 8 4)
...
for SOURCE_N_SEGMENTS in 1 2 3 4
do
K2=${SOURCE_N_SEGMENTS}
SOURCE_INPUT_SIZE=128
...
horovodrun --gloo -np $NP python run_finetuning_arxiv_rmt.py \
        ...
        --model_cls $MODEL_CLS \
        --model_cpt ../runs/${TASK_NAME}/gpt2/linear_adamw_wd1e-03_$(((SOURCE_INPUT_SIZE-2*MEMORY_SIZE)*SOURCE_N_SEGMENTS))-128-${SOURCE_N_SEGMENTS}x${SOURCE_INPUT_SIZE}_mem${MEMORY_SIZE}_bs32_${SEGMENT_ORDERING}_bptt-${K2}_from_cpt_$((SOURCE_N_SEGMENTS-1))-${SOURCE_N_SEGMENTS}/run_$N \
