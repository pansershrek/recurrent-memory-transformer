...
MODEL_CFG=/home/jovyan/rmt/wip/base_models/gptconfigs/neox_tiny_4l4h.json
...
accelerate launch --config_file ./accel_configs/np-1.yaml --main_process_port 29524 run_finetuning_associative_retrieval.py \
        --task_name $TASK_NAME \
        --model_path ../runs/${TASK_NAME}/$MODEL_NAME/lr${LR}_${SCHEDULER}_adamw_wd1e-03_k${KEY_SIZE}-v${VALUE_SIZE}-p${NUM_PAIRS}-${MAX_N_SEGMENTS}x${INPUT_SIZE}_mem${MEMORY_SIZE}_bs${TBS}_${SEGMENT_ORDERING}_bptt-${K2}_4l4h/run_$N \
        --model_cfg $MODEL_CFG \
