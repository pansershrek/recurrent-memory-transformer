...
if __name__ == '__main__':
    ...
    class BlockDataLoader(DataLoaderDispatcher):
        ...
        #     document = self 
        #     return tokenizer.encode(document['text'])
    ...
    # class BlockSampler(BatchSampler):
    #     def __init__(self, dataset, block_size, history_size, max_samples=None, shuffle=False, *args, **kwargs):
    #         super().__init__(dataset, *args, **kwargs)
    ...
    if not args.validate_only:
        train_dataloader = BlockDataLoader(train_dataset, 
                                        split_batches=True,
                                        batch_size=per_worker_batch_size,  generator=train_rnd_generator,
                                        block_size=block_size, 
                                        history_size=history_size, 
                                        shuffle=True,
                                        collate_fn=collate_fn, **kwargs)
        # train_sampler = BlockSampler(train_dataset, batch_size=per_worker_batch_size,
        #                                 block_size=block_size, 
        #                                 history_size=history_size, 
    ...
    valid_dataloader = BlockDataLoader(valid_dataset, 
                                    split_batches=True,
    ...
    # valid_sampler = BlockSampler(valid_dataset, batch_size=per_worker_batch_size,
    #                                 block_size=block_size, 
    #                                 history_size=history_size, 
    #                                 # collate_fn=collate_fn,
    #                                 shuffle=False,
    ...
    # valid_dataloader = prepare_data_loader(valid_dataloader)
